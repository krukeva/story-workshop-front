...
export default function DeleteOrganisation() {
  ...
  const organisation = useOutletContext()
  const navigate = useNavigate()

  return (
    <Modal show={show} onClose={() => setShow(false)}>
      <Modal.Header>Suppression d'une Organisation</Modal.Header>
      <Modal.Body>
        <p>
          Merci de confirmer la suppression de l'organisation{" "}
          <b>
            &laquo;&nbsp;{`${organisation.name}`}
            &nbsp;&raquo;.
          </b>
        </p>
      </Modal.Body>
